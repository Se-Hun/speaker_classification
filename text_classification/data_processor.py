...
class TopicProcessor(DataProcessor):
    ...
    def get_labels(self):
        # return ["일상", "교육 및 학교 (교과목, 진로, 입시, 성적, 스터디)", "주거와 생활 (집안일, 육아, 부동산, 경제 활동, 생활 정보)",
        ...
        #         "날씨와 계절", "미용과 건강 (질병과 치료, 운동, 다이어트, 미용)"] # excluding less than number of examples about certain label
